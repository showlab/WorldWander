...
<p align="center">
    ...
    <span> 
        ...
        <img src='https://img.shields.io/badge/Checkpoints-WorldWander-blue' alt='Hugging Face'></a> &emsp;  &emsp;
    </span>
</p>
...
| ---------------------------------- | --------------------- | ------------------------------------------- |
| wan2.2-TI2V-5B_three2one_synthetic | 🤗 [Huggingface](https://huggingface.co/QuintonSung/WorldWander/resolve/main/wan2-2_lora_three2one_synthetic.ckpt) | configs/wan2-2_lora_three2one_synthetic.yaml |
...
| wan2.2-TI2V-5B_three2one_realworld | 🤗 [Huggingface](https://huggingface.co/QuintonSung/WorldWander/resolve/main/wan2-2_lora_three2one_realworld.ckpt) | configs/wan2-2_lora_three2one_realworld.yaml |
